...
class DatasetAttr:
    ...
    pt_separator_tag: Optional[str] = "pt_separator"
    pt_content_tag: Optional[str] = "pt_content"
    # reasoning/thinking config
    thinking_prompt: Optional[Literal["on", "off", "auto", "none","passthrough"]] = "passthrough"
    ...
    def join(self, attr: dict[str, Any]) -> None:
        ...
        self.set_attr("thinking_prompt", attr, default="passthrough")
        ...
        if "tags" in attr:
            ...
            tag_names += ["user_tag", "assistant_tag", "observation_tag", "function_tag", "system_tag", "pt_separator_tag", "pt_content_tag"]
