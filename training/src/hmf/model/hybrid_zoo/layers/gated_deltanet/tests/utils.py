...
def get_argparser():
    parser = argparse.ArgumentParser(description="ZigZag‑GDN distributed sanity‑check")

    parser.add_argument("--exp_name", type=str, default="gdn", help="Experiment name")
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to state_dict for loading GDN parameters",
    )
    parser.add_argument(
        "--sp",
        type=int,
...
def logs_to_json(args, logs, exp_name="gated_deltanet"):
    record = {
