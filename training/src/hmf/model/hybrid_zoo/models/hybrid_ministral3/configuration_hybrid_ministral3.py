...
"""HybridMinistral3 model configuration"""
...
class HybridMinistral3Config(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`HybridMinistral3Model`]. It is used to instantiate
    a Hybrid Ministral3 model according to the specified arguments, defining the model architecture.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 131072):
            Vocabulary size of the HybridMinistral3 model.
...
__all__ = ["HybridMinistral3Config"]
