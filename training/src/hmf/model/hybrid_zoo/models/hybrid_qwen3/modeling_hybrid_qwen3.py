...
"""PyTorch Hybrid Qwen3 model.

This module implements a hybrid variant of the Qwen3 architecture that supports replacing standard
...
Architecture:
    This model architecture is based on Qwen3, but allows flexible layer composition through a
    hybrid override pattern specified in the model configuration. Each decoder layer can be either:
    - Standard Qwen3 attention layer (Qwen3DecoderLayer)
    - One of several hybrid layer types (subclasses of Qwen3HybridDecoderLayerBase)
    - Fused attention-hybrid layers for layerwise MSE distillation (subclasses of Qwen3FusedAttHybridDecoderLayer)
...
class Qwen3RotaryEmbedding(nn.Module):
    ...
    def __init__(self, config: HybridQwen3Config, device=None):
        super().__init__()
    ...
    def compute_default_rope_parameters(
        config: HybridQwen3Config | None = None,
...
class Qwen3Attention(nn.Module):
    ...
    def __init__(self, config: HybridQwen3Config, layer_idx: int):
        super().__init__()
        self.config = config
...
class Qwen3SWAttention(Qwen3Attention):
    def __init__(self, config: HybridQwen3Config, layer_idx: int):
...
class Qwen3HybridDecoderLayerBase(GradientCheckpointingLayer, ABC):
    """
    ...
    def __init__(self, config: HybridQwen3Config, layer_idx: int):
        ...
        self.hidden_size = config.hidden_size
        self.attention_type = "full_attention" # Use same mask as Attention
    ...
    @abstractmethod
    def _init_seq_mixer(self, config: HybridQwen3Config, layer_idx: int):
...
class Qwen3Mamba2DecoderLayer(Qwen3HybridDecoderLayerBase):
...
class Qwen3BMOJOFDecoderLayer(Qwen3HybridDecoderLayerBase):
...
class Qwen3GDNDecoderLayer(Qwen3HybridDecoderLayerBase):
...
class Qwen3GKADecoderLayer(Qwen3HybridDecoderLayerBase):
...
class Qwen3SWADecoderLayer(Qwen3HybridDecoderLayerBase):
    ...
    def _init_seq_mixer(self, config: HybridQwen3Config, layer_idx: int):
        self.swa = Qwen3SWAttention(config, layer_idx=layer_idx)

    @property
    def seq_mixer(self):
        return self.swa

class Qwen3DualAttDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: HybridQwen3Config, layer_idx: int):
        """
...
class Qwen3FusedAttHybridDecoderLayer(GradientCheckpointingLayer, ABC):
    def __init__(self, config: HybridQwen3Config, layer_idx: int):
        """
    ...
    @abstractmethod
    def _init_hybrid_seq_mixer(self, config: HybridQwen3Config, layer_idx: int):
        """Initializes the sequence mixer (e.g., Mamba2, B'MOJO, etc.)."""
        pass
...
class Qwen3FusedAttMamba2DecoderLayer(Qwen3FusedAttHybridDecoderLayer):
    @property
    def hybrid_seq_mixer(self) -> nn.Module:
        return self.mamba
...
class Qwen3FusedAttBMojoFDecoderLayer(Qwen3FusedAttHybridDecoderLayer):
    @property
    def hybrid_seq_mixer(self) -> nn.Module:
        return self.bmojo_f
...
class Qwen3FusedAttGDNDecoderLayer(Qwen3FusedAttHybridDecoderLayer):
    @property
    def hybrid_seq_mixer(self) -> nn.Module:
        return self.gdn
...
class Qwen3FusedAttGKADecoderLayer(Qwen3FusedAttHybridDecoderLayer):
    @property
    def hybrid_seq_mixer(self) -> nn.Module:
        return self.gka
...
class Qwen3FusedAttSWADecoderLayer(Qwen3FusedAttHybridDecoderLayer):
    @property
    def hybrid_seq_mixer(self) -> nn.Module:
        return self.swa
...
HYBRID_QWEN3_DECODER_LAYER_REGISTRY = build_decoder_layer_registry(
    module_or_dict=sys.modules[__name__],
    model_prefix="Qwen3"
)

@auto_docstring
class HybridQwen3PreTrainedModel(PreTrainedModel):
    config_class = HybridQwen3Config
...
@auto_docstring
class HybridQwen3Model(HybridQwen3PreTrainedModel):
    ...
    def _set_decoder_layers(self, config):
        ...
        """
        return set_decoder_layers_from_pattern(config, HYBRID_QWEN3_DECODER_LAYER_REGISTRY)
...
@auto_docstring
class HybridQwen3ForCausalLM(HybridQwen3PreTrainedModel, GenerationMixin):
...
class HybridQwen3ForSequenceClassification(GenericForSequenceClassification, HybridQwen3PreTrainedModel):
    pass


class HybridQwen3ForTokenClassification(GenericForTokenClassification, HybridQwen3PreTrainedModel):
    pass


class HybridQwen3ForQuestionAnswering(GenericForQuestionAnswering, HybridQwen3PreTrainedModel):
