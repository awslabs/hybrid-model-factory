...
class Qwen3_5MoeHMFTextConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen3_5MoeHMFTextModel`]. It is used to instantiate a
    ...
    model_type = "qwen3_5_moe_hmf_text"
...
class Qwen3_5MoeHMFVisionConfig(PreTrainedConfig):
    model_type = "qwen3_5_moe_hmf"
...
class Qwen3_5MoeHMFConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Qwen3_5MoeHMFModel`]. It is used to instantiate a
    Qwen3.5-MoE model according to the specified arguments, defining the model architecture. 
    ...
    model_type = "qwen3_5_moe_hmf"
    sub_configs = {"vision_config": Qwen3_5MoeHMFVisionConfig, "text_config": Qwen3_5MoeHMFTextConfig}
    keys_to_ignore_at_inference = ["past_key_values"]
...
__all__ = ["Qwen3_5MoeHMFConfig", "Qwen3_5MoeHMFTextConfig"]
