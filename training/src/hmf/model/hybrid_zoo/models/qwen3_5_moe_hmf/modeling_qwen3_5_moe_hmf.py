...
from .configuration_qwen3_5_moe_hmf import Qwen3_5MoeHMFConfig, Qwen3_5MoeHMFTextConfig, Qwen3_5MoeHMFVisionConfig
...
class Qwen3_5MoeTextRotaryEmbedding(nn.Module):
    ...
    def __init__(self, config: Qwen3_5MoeHMFTextConfig, device=None):
        super().__init__()
    ...
    def compute_default_rope_parameters(
        config: Qwen3_5MoeHMFTextConfig | None = None,
...
class Qwen3_5MoeDynamicCache:
    ...
    def __init__(self, config: Qwen3_5MoeHMFConfig):
        super().__init__()
...
class Qwen3_5MoeGatedDeltaNet(nn.Module):
    def __init__(self, config: Qwen3_5MoeHMFConfig, layer_idx: int):
        super().__init__()
...
class Qwen3_5MoeAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        # Remove position_ids from kwargs to prevent it from leaking into flash attention.
        # The 3D MRoPE position_ids (3, batch, seq_len) would be misinterpreted by
        # _is_packed_sequence which expects 2D (batch, seq_len), causing flash_attn_varlen_func
        # to compute wrong cu_seqlens and trigger illegal memory access.
        # position_ids is only needed for RoPE, which is already applied via position_embeddings.
...
class Qwen3_5MoeMLP(nn.Module):
    def __init__(self, config: Qwen3_5MoeHMFConfig, intermediate_size: int):
        super().__init__()
        self.config = config
        self.hidden_size = config.hidden_size
...
class Qwen3_5MoeDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3_5MoeHMFTextConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        hidden_states = self.mlp(hidden_states) # No need to unpack
        hidden_states = residual + hidden_states

        return hidden_states


class Qwen3_5MoeHybridDecoderLayerBase(GradientCheckpointingLayer, ABC):
    """
    ...
    @abstractmethod
    def _init_seq_mixer(self, config: Qwen3_5MoeHMFTextConfig, layer_idx: int):
...
class Qwen3_5MoeBMOJOFDecoderLayer(Qwen3_5MoeHybridDecoderLayerBase):
...
class Qwen3_5MoeGDNDecoderLayer(Qwen3_5MoeHybridDecoderLayerBase):
...
class Qwen3_5MoeGKADecoderLayer(Qwen3_5MoeHybridDecoderLayerBase):
...
class Qwen3_5MoeDualAttDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3_5MoeHMFTextConfig, layer_idx: int):
        """
    ...
    def _forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        residual = hidden_states
        hidden_states = self.post_attention_layernorm(hidden_states)
        hidden_states_mlp = self.mlp(hidden_states) # No need to unpack
...
class Qwen3_5MoeFusedAttHybridDecoderLayer(GradientCheckpointingLayer, ABC):
    def __init__(self, config: Qwen3_5MoeHMFTextConfig, layer_idx: int):
        """
        ...
        see Qwen3_5MoeFusedAttGKADecoderLayer).
        """
        super().__init__()
        self.hidden_size = config.hidden_size
        self.attention_type = "full_attention"
    ...
    @abstractmethod
    def _init_hybrid_seq_mixer(self, config: Qwen3_5MoeHMFTextConfig, layer_idx: int):
...
class Qwen3_5MoeFusedAttBMojoFDecoderLayer(Qwen3_5MoeFusedAttHybridDecoderLayer):
    @property
    def hybrid_seq_mixer(self) -> nn.Module:
        return self.bmojo_f
...
class Qwen3_5MoeFusedAttGDNDecoderLayer(Qwen3_5MoeFusedAttHybridDecoderLayer):
    @property
    def hybrid_seq_mixer(self) -> nn.Module:
        return self.gdn
...
class Qwen3_5MoeFusedAttGKADecoderLayer(Qwen3_5MoeFusedAttHybridDecoderLayer):
    @property
    def hybrid_seq_mixer(self) -> nn.Module:
        return self.gka
...
class Qwen3_5MoeFusedHybridHybridDecoderLayer(GradientCheckpointingLayer, ABC):
    def __init__(self, config: Qwen3_5MoeHMFTextConfig, layer_idx: int):
        """
    ...
    @abstractmethod
    def _init_source_hybrid_seq_mixer(self, config: Qwen3_5MoeHMFTextConfig, layer_idx: int):
        """Initializes the sequence mixer which we will distill from."""
        pass

    @abstractmethod
    def _init_target_hybrid_seq_mixer(self, config: Qwen3_5MoeHMFTextConfig, layer_idx: int):
...
class Qwen3_5MoeFusedGDNToGKADecoderLayer(Qwen3_5MoeFusedHybridHybridDecoderLayer):
    @property
    def source_seq_mixer(self) -> nn.Module:
        return self.gdn
...
QWEN3_5MOE_DECODER_LAYER_REGISTRY = build_decoder_layer_registry(
    module_or_dict=sys.modules[__name__],
    model_prefix="Qwen3_5Moe"
)


class Qwen3_5MoeHMFPreTrainedModel(PreTrainedModel):
    config: Qwen3_5MoeHMFConfig
...
class Qwen3_5MoeVisionPatchMerger(nn.Module):
    def __init__(self, config: Qwen3_5MoeHMFVisionConfig, use_postshuffle_norm=False) -> None:
        super().__init__()
...
class Qwen3_5MoeVisionAttention(nn.Module):
    def __init__(self, config: Qwen3_5MoeHMFVisionConfig) -> None:
        super().__init__()
...
class Qwen3_5MoeHMFVisionModel(Qwen3_5MoeHMFPreTrainedModel):
    config: Qwen3_5MoeHMFVisionConfig
...
class Qwen3_5MoeHMFModelOutputWithPast(ModelOutput):
    r"""
...
class Qwen3_5MoeHMFTextModel(Qwen3_5MoeHMFPreTrainedModel):
    def __init__(self, config: Qwen3_5MoeHMFTextConfig):
    ...
    def _set_decoder_layers(self, config):
        ...
        """
        return set_decoder_layers_from_pattern(config, QWEN3_5MOE_DECODER_LAYER_REGISTRY)
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return Qwen3_5MoeHMFModelOutputWithPast(
            last_hidden_state=hidden_states,
            past_key_values=past_key_values,
        )
...
@auto_docstring
class Qwen3_5MoeHMFModel(Qwen3_5MoeHMFPreTrainedModel):
    base_model_prefix = "model"
    ...
    def __init__(self, config):
        super().__init__(config)
        self.visual = Qwen3_5MoeHMFVisionModel._from_config(config.vision_config)
        self.language_model = Qwen3_5MoeHMFTextModel._from_config(config.text_config)
    ...
    def forward(
        ...
        cache_position: torch.LongTensor | None = None,
        **kwargs: Unpack[TransformersKwargs],
    ) -> tuple | Qwen3_5MoeHMFModelOutputWithPast:
        r"""
        image_grid_thw (`torch.LongTensor` of shape `(num_images, 3)`, *optional*):
            The temporal, height and width of feature shape of each image in LLM.
        video_grid_thw (`torch.LongTensor` of shape `(num_videos, 3)`, *optional*):
...
@auto_docstring
class Qwen3_5MoeHMFForCausalLM(Qwen3_5MoeHMFPreTrainedModel, GenerationMixin):
    _tied_weights_keys = {"lm_head.weight": "model.embed_tokens.weight"}
    _tp_plan = {"lm_head": "colwise_gather_output"}
    _pp_plan = {"lm_head": (["hidden_states"], ["logits"])}
    config: Qwen3_5MoeHMFTextConfig
    _keys_to_ignore_on_load_unexpected = [r"^mtp.*", r"^model.visual.*"]

    def __init__(self, config):
        super().__init__(config)
        self.model = Qwen3_5MoeHMFTextModel(config)
...
class Qwen3_5MoeHMFForConditionalGeneration(Qwen3_5MoeHMFPreTrainedModel, GenerationMixin):
    _checkpoint_conversion_mapping = {}
    ...
    def __init__(self, config):
        super().__init__(config)
        self.model = Qwen3_5MoeHMFModel(config)
...
__all__ = [
    "Qwen3_5MoeHMFVisionModel",
    "Qwen3_5MoeHMFTextModel",
    "Qwen3_5MoeHMFModel",
    "Qwen3_5MoeHMFForCausalLM",
    "Qwen3_5MoeHMFForConditionalGeneration",
    "Qwen3_5MoeHMFPreTrainedModel",
]
