...
"""Qwen3-Next for Hybrid Model Factory (HMF) model configuration"""
...
class Qwen3NextHMFConfig(PreTrainedConfig):
    r"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Use simple assert for hybrid models since they use custom layer types (M2, GKA, etc.)
