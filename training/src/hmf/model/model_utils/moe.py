...
def add_z3_leaf_module(model: "PreTrainedModel") -> None:
    ...
    if model_type == "hybrid_qwen3_moe":
        from ..hybrid_zoo.models.hybrid_qwen3_moe.modeling_hybrid_qwen3_moe import Qwen3MoeSparseMoeBlock
    ...
    if model_type == "qwen3_next_hmf":
        from ..hybrid_zoo.models.qwen3_next_hmf.modeling_qwen3_next_hmf import Qwen3NextSparseMoeBlock
    ...
    if model_type in ("qwen3_5_moe_hmf", "qwen3_5_moe_hmf_text"):
        from ..hybrid_zoo.models.qwen3_5_moe_hmf import Qwen3_5MoeSparseMoeBlock
