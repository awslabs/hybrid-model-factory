...
from ..trainer_utils import SaveShardMixin, create_custom_optimizer, create_custom_scheduler, get_batch_logps, nested_detach
...
class CustomKTOTrainer(SaveShardMixin, KTOTrainer):
    def __init__(
        self,
