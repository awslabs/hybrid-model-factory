...
USAGE = (
    ...
    + "\n"
    + "| Usage:                                                             |\n"
    + "|   hybridfactory sft -h: train models                               |\n"
...
def launch():
    ...
    # NOTE:
    # `hybridfactory <command> ...` enters here first.
    ...
    if command in _DIST_TRAIN_COMMANDS and (
        ...
        if command in ("train", "sft"):
            from hmf.v1.trainers.sft_trainer import run_sft
...
def main():
    ...
    if command in ("train", "sft"):
        ...
        # from hmf.v1.trainers.dpo_trainer import run_dpo
        # run_dpo()
        raise NotImplementedError("DPO trainer is not implemented yet.")
    elif command == "rm":
        # from hmf.v1.trainers.rm_trainer import run_rm
        # run_rm()
        raise NotImplementedError("RM trainer is not implemented yet.")
