...
from hmf.data import get_template_and_fix_tokenizer
from hmf.data.collator import MultiModalDataCollatorForSeq2Seq, prepare_4d_attention_mask
from hmf.extras.constants import IGNORE_INDEX
from hmf.hparams import get_infer_args
from hmf.model import load_tokenizer
